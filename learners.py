...
class Lrnr_sl(Learner):
    def __init__(self, sl_task: KFold, stack: list, meta: str , name = None, params = None):
...
class Lrnr_glm(Learner):
    def __init__(self, sl_task: KFold, name = None, params = None):
        super().__init__(sl_task = sl_task, name = name, params = params)
...
class Lrnr_glmnet(Learner):
    ...
    def __init__(self, sl_task: KFold, name = None, params = [1, 1e-2]):
        super().__init__(sl_task = sl_task, name = name, params = params)
        self.L1_wt = params[0]
...
class Lrnr_rf(Learner):
    def __init__(self, sl_task: KFold, name = None, params = [3, None, 2]):
        super().__init__(sl_task = sl_task, name = name, params = params)
...
class Lrnr_xgboost(Learner):
    def __init__(self, sl_task: KFold, num_round: int, name = None, params = [3, 1e-1, 100, 1, 1]):
        super().__init__(sl_task = sl_task, name = name, params = params)
